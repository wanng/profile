...
const getOneDateCalendarInfo_url = `https://qy.do1.com.cn/wxqyh/portal/checkWorkDateCtrl/getOneDateCalendarInfo.do`;
const getOneDateCalendarInfo_method = `POST`;
const getOneDateCalendarInfo_body = `searchDate=2024-10-12&userId=&belongAgent=checkwork`;

const getOneDateCalendarInfo_request = {
    url: getOneDateCalendarInfo_url,
    method: getOneDateCalendarInfo_method,
    headers: do1Headers,
    body: getOneDateCalendarInfo_body
};
...
var Task = {
    check: function(callback) {
        getOneDateCalendarInfo_request.headers['Cookie'] = Store.get(cookieKey);
        getOneDateCalendarInfo_request['body'] = `searchDate=` + Now.today() + `&userId=&belongAgent=checkwork`;
    ...
    run: function () {
        var execProbability =  parseInt(Store.get(execProbabilityKey))
        if (!execProbability) {
            execProbability = 10
        }
